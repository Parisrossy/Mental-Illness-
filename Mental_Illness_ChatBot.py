...
#-----------STREAMLIT DESIGN------------
st.markdown("<h1 style = 'color: #1640D6; text-align: center; font-family: helvetica '>MENTAL HEALTH CHATBOT</h1>", unsafe_allow_html = True)

st.markdown("<h4 style = 'margin: -25px; color: #FFC436; text-align: center; font-family: montserrat '>BUILT BY OLUWAYOMI ROSEMARY</h4>", unsafe_allow_html = True)

st.markdown("<br> <br>", unsafe_allow_html= True)
col1, col2 = st.columns(2)
col1.image('pngwing.com (3).png', caption = 'Mental Health Related Chats')
